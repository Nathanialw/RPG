...
namespace Tooltip {
	...
	SDL_FRect Get_And_Scale_TooltipBox(entt::registry& zone, Component::Camera& camera, SDL_FRect &tooltipBox) {
		return Camera_Control::Convert_FRect_To_Scale(zone, tooltipBox, camera);
	}
