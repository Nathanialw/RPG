...
namespace SQLite_Spritesheets {
  ...
  std::unordered_map<std::string, Rendering_Components::Sheet_Data_Flare>* Populate_Flare_SpriteSheet(std::string &name, Sheet_Data_Flare &data, SDL_Texture* texture) {
    if (Flare_Spritesheets[name].texture == NULL) {
      ...
      Flare_Spritesheets[name].actionFrameData[Action_Component::block] = data.block;
      Flare_Spritesheets[name].actionFrameData[Action_Component::attack] = data.attack;
      Flare_Spritesheets[name].actionFrameData[Action_Component::run] = data.run;
      Flare_Spritesheets[name].actionFrameData[Action_Component::idle] = data.idle;
      Flare_Spritesheets[name].actionFrameData[Action_Component::struck] = data.struck;
      Flare_Spritesheets[name].actionFrameData[Action_Component::dying] = data.dying;
      Flare_Spritesheets[name].actionFrameData[Action_Component::cast] = data.cast;
      Flare_Spritesheets[name].actionFrameData[Action_Component::attack2] = data.attack2;
      Flare_Spritesheets[name].actionFrameData[Action_Component::behavior] = data.behavior;
      Flare_Spritesheets[name].actionFrameData[Action_Component::cheer] = data.cheer;
      Flare_Spritesheets[name].actionFrameData[Action_Component::evade] = data.evade;
      Flare_Spritesheets[name].actionFrameData[Action_Component::isStatic] = data.isStatic;
      Flare_Spritesheets[name].actionFrameData[Action_Component::idle_low_hp] = data.low_hp;
      Flare_Spritesheets[name].actionFrameData[Action_Component::ranged] = data.ranged;
      Flare_Spritesheets[name].actionFrameData[Action_Component::resting] = data.resting;
      Flare_Spritesheets[name].actionFrameData[Action_Component::stunned] = data.stunned;
