...
namespace Character_Create {
  ...
  Character_Options::Customization Customize(Character_Options::Customization &options) {
    ...
    menus.emplace_back(Create_Menu({"orc", "zombie", "skeleton", "demon", "fleshbeast", "elves", "euro", "asian", "indian", "african", /*"half-orc", "goblin", "orc",*/ "elf", "human", "dwarf"}, (int) options.species, 0.1f, 0.1f, vertical));
