...
namespace User_Mouse_Input {
  ...
  bool Select_Soldier(entt::registry &zone, entt::entity player_ID) {
    ...
    auto soldier_view = zone.view<Component::Interaction_Rect, Component::Renderable>(entt::exclude<Item_Component::Ground_Item>);
  ...
  void Select_Units(entt::registry &zone, entt::entity player_ID) {
    ...
    if (view.empty()) {
      switch (eUnit_Selection) {
        case Unit_Selection::soldiers:
          Select_Soldier(zone, player_ID);
          break;
        case Unit_Selection::squads:
          Select_Squad(zone);
          break;
        case Unit_Selection::platoons:
          Select_Platoon(zone);
          break;
        case Unit_Selection::companies:
          Select_Company(zone);
          break;
        case Unit_Selection::battalions:
          Select_Battalion(zone);
          break;
      }
