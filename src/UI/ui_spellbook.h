...
namespace UI_Spellbook {
  ...
  void Build_Spellbook() {
    ...
    spellbook.Skill_Trees[Spell_Data::cold][0] = Spell_Data::Spell(Graphics::icebolt, Ice_Bolt::Cast_Spell);
    spellbook.Skill_Trees[Spell_Data::cold][1] = Spell_Data::Spell(Graphics::Snowflake1, Snowflake1::Cast_Spell);
    spellbook.Skill_Trees[Spell_Data::cold][2] = Spell_Data::Spell(Graphics::Snowflake2, Snowflake2::Cast_Spell);
    ...
    spellbook.Skill_Trees[Spell_Data::arcane][0] = Spell_Data::Spell(Graphics::warp_effect, Arcane::Cast_Spell);
    spellbook.Skill_Trees[Spell_Data::arcane][1] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::arcane][2] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::arcane][3] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::arcane][4] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::arcane][5] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::arcane][6] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::arcane][7] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::arcane][8] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    ...
    spellbook.Skill_Trees[Spell_Data::lightning][6] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::lightning][7] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::lightning][8] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::lightning][9] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::lightning][10] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::lightning][11] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);

    spellbook.Skill_Trees[Spell_Data::air][0] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][1] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][2] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][3] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][4] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][5] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][6] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][7] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][8] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][9] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][10] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
    spellbook.Skill_Trees[Spell_Data::air][11] = Spell_Data::Spell(Graphics::default_icon, PLACEHOLDER);
