...
namespace Spells {
    ...
    Rendering_Components::Static_Sprite_Animation_Data Get_Spell_Texture(entt::registry &zone, entt::entity &entity, int &state, entt::entity &caster_ID, Component::Position &position, Component::Direction &direction, const char *spellname, std::string &xml, std::string &image) {
    ...
    Rendering_Components::Static_Sprite_Animation_Data Spell_Cast_Effect(entt::registry &zone, int &state, entt::entity &caster_ID, Component::Position &position, Component::Direction &direction, const char *spellname, float &targetX, float &targetY) {
	if (!spellname)
	    return {};
